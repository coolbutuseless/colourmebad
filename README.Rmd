...
`colourmebad` provides some tools for finding pronouncable approximations to hex colours.
...
* Included colour lists
    ...
    * `nonsense_words` hex colours which could almost be read as a pronouncable
